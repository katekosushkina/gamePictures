...
} while (randImgIndex10 == randImgIndex1 || randImgIndex10 == randImgIndex2|| randImgIndex10 == randImgIndex3);
 ...
 $('.place').droppable( {  tolerance:'touch',  out: function(event, ui){  $(this).removeClass("dropped")}, drop : function(event, ui) {
  ...
  $(function() {
    $( "#opener" ).click(function() {
        ...
        console.log(flag);
		if ($('#quest1').prev().length > 0 &&$('#quest2').prev().length > 0 &&$('#quest3').prev().length > 0&& flag==0){
			$(location).attr('href', '../html/game4.html');
		}else{
      $( "#dialog" ).dialog( "open" );
		}
    });
