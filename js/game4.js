...
} while (randImgIndex10 == randImgIndex1 || randImgIndex10 == randImgIndex2|| randImgIndex10 == randImgIndex3|| randImgIndex10 == randImgIndex3|| randImgIndex10 == randImgIndex4);
...
$('#quest1').droppable( { activeClass:'ACT', hoverClass:'HOV', tolerance:'touch', out: function(event, ui){  $(this).removeClass("dropped")},  drop : onDrag
 ...
 $(function() {
    $( "#opener" ).click(function() {
        ...
        console.log(flag);
		if ($('#quest1').prev().length > 0 &&$('#quest2').prev().length > 0 &&$('#quest3').prev().length > 0 &&$('#quest4').prev().length > 0 && flag==0){
			$(location).attr('href', '../html/game5.html');
		}else{
      $( "#dialog" ).dialog( "open" );
		}
    });
