...
var randDivIndex10 = randDivIndex[9];
...
var randArtistIndex10 = randArtistIndex[9];
...
var randImgIndex10 = randArtistIndex10;
...
var selectedDiv10 = $('#g' + randDivIndex10);
console.log(selectedDiv10);
selectedDiv10.html('<img data-selected=' + randImgIndex10 + ' src="../images/game/' + images[randImgIndex10] + '.jpg">');
...
$('#artistName10').append(artists[randArtistIndex10]);
$('#quest10').attr('data-selected', randImgIndex10);
...
$('#quest1').droppable( { activeClass:'ACT', hoverClass:'HOV', tolerance:'touch', out: function(event, ui){  $(this).removeClass("dropped")},  drop : onDrag
 ...
 $('#quest2').droppable( { activeClass:'ACT', hoverClass:'HOV', tolerance:'touch', out: function(event, ui){  $(this).removeClass("dropped")},  drop : onDrag
  ...
  $('#quest10').droppable( { activeClass:'ACT', hoverClass:'HOV', tolerance:'touch', out: function(event, ui){  $(this).removeClass("dropped")},  drop : onDrag
 } );
 ...
 $(function() {
    $( "#opener" ).click(function() {
		...
		&&$('#quest5').prev().length > 0 &&$('#quest6').prev().length > 0 &&$('#quest7').prev().length > 0 &&$('#quest8').prev().length > 0 &&$('#quest9').prev().length > 0 &&$('#quest10').prev().length > 0 && flag==0){
			
        $( "#dialog1" ).dialog( "open" );
	    $('footer').html('<audio autoplay><source src="../images/winner.mp3" type="audio/mp3"></audio>');
		}else{
		$( "#dialog" ).dialog( "open" );
		}
    });
